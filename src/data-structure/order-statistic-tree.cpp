...
// sorted order. It performs all the operations as performed by the set data structure in
// STL in log(n) complexity and performs two additional operations also in log(n)
// complexity order_of_key (k) : Number of items strictly smaller than k find_by_order(k)
// : K‐th element in a set (counting from zero) tree<key_type, value_type(set if null),
// comparator, ...>
using ordered_set =
    tree<int, null_type, less<int>, rb_tree_tag, tree_order_statistics_node_update>;
using ordered_multi_set =
